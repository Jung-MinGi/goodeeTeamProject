...
<form method="post" action="/book/bookUpdate">
	...
	<input type="number" id="b_num" name="b_num" value="${bookVo.b_num }" readonly>
	<br>
	...
	<input type="radio" name="b_category" value="1" ${bookVo.b_category eq '1' ? 'checked' : ''}>
	<label for="category1">1</label>
	<input type="radio" name="b_category" value="2" ${bookVo.b_category eq '2' ? 'checked' : ''}>
	<label for="category2">2</label>
	<input type="radio" name="b_category" value="3" ${bookVo.b_category eq '3' ? 'checked' : ''}>
	<label for="category3">3</label>
	<input type="radio" name="b_category" value="4" ${bookVo.b_category eq '4' ? 'checked' : ''}>
	<label for="category4">4</label>
	<input type="radio" name="b_category" value="5" ${bookVo.b_category eq '5' ? 'checked' : ''}>
	<label for="category5">5</label>
	<br>
	<label for="b_purchase">누적구매횟수</label>
	<input type="number" id="b_purchase" name="b_purchase" min="0" value="${bookVo.b_purchase }" readonly> 
